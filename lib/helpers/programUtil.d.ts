...
import type { HasPublicKey, IdlMetadata, MarketAccount, ObligationAccount, ReserveAccount, ReserveConfigStruct, ToBytes } from './honeyTypes';
...
export declare const parseU192: (data: Buffer | number[]) => BN;
